segment datos data
		...
		mensajeIgualdadConjuntos db 'Los conjuntos son iguales$'
		mensajeNoIgualdadConjuntos db 'Los conjuntos no son iguales$'
...
;**********************************************************************
; Verificar la igualdad entre dos conjuntos
;**********************************************************************
igualdadConjuntos:
		call pedirIngresoConjunto
		...
		call estaIncluido
		cmp byte[flagIncluido],"F"
		je msgConjuntosNoIguales
		
		;Intercambio los valores de los conjuntos
		mov ah,[numeroConjuntoDos]
		xchg ah,[numeroConjuntoUno]
		mov byte[numeroConjuntoDos],ah
